...
public class optBeams {
	...
	public optBeams(int leveltd, ArrayList CGLEW, ArrayList CGLNS, int bRow, int bColumn, ArrayList<ArrayList<ArrayList<Column>>> col, int numLvls, int sWidth, PApplet p){
		parent = p;
		x = bRow;
		y = bColumn;
		z = numLvls;
